...
CREATE TABLE "new_EvaluacionActual" (
    ...
    CONSTRAINT "EvaluacionActual_pacienteId_fkey" FOREIGN KEY ("pacienteId") REFERENCES "OrdenQuirurgicaIntrauterina" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
