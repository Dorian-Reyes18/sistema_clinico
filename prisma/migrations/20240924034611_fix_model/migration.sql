/*
  ...
  - You are about to drop the column `ubicacionPlacentariaId` on the `IntrauterinaAbierta` table. All the data in the column will be lost.
...
INSERT INTO "new_IntrauterinaAbierta" ("cierreDeEncefalocele", "cierreDeMielomeningocele", "complicacionesAnestesicas", "complicacionesQuirurgicas", "derivacionVentriculoamniotica", "diagnosticoPrenatalId", "drenajeDeQuistesCoroideosUniOBilaterales", "fechaCirugia", "frecuenciaCardiacaFetalFinalizacion", "frecuenciaCardiacaFetalInicio", "horaFinalizacionCirugia", "horaInicioAnestesia", "horaInicioCirugiaFetal", "horaInicioCirugiaMaterna", "id", "ilaFinalBolsilloUnicoInicialDeLiquidoAmniotico", "ilaInicialDeLiquidoAmniotico", "incisionEnPiel", "incisionEnUtero", "intrauterinaId", "nivelAnatomico", "nivelFuncional", "sangreEstimado", "tamanoDelDefecto", "tipoAnestesiaId") SELECT "cierreDeEncefalocele", "cierreDeMielomeningocele", "complicacionesAnestesicas", "complicacionesQuirurgicas", "derivacionVentriculoamniotica", "diagnosticoPrenatalId", "drenajeDeQuistesCoroideosUniOBilaterales", "fechaCirugia", "frecuenciaCardiacaFetalFinalizacion", "frecuenciaCardiacaFetalInicio", "horaFinalizacionCirugia", "horaInicioAnestesia", "horaInicioCirugiaFetal", "horaInicioCirugiaMaterna", "id", "ilaFinalBolsilloUnicoInicialDeLiquidoAmniotico", "ilaInicialDeLiquidoAmniotico", "incisionEnPiel", "incisionEnUtero", "intrauterinaId", "nivelAnatomico", "nivelFuncional", "sangreEstimado", "tamanoDelDefecto", "tipoAnestesiaId" FROM "IntrauterinaAbierta";
